        ...
        <div className="navbar max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 min-h-16">
          ...
          <div className="navbar-end gap-3">
            ...
            {isPending ? (
              ...
              // ✅ Avatar + Name + SignOut — সব একসাথে দেখাবে
              <div className="flex items-center gap-2">
                ...
                {/* ✅ User name */}
                <span className="hidden lg:block text-sm font-medium text-base-content truncate max-w-[100px]">
                  {user.name}
                </span>
                ...
                <button
                  ...
                  className="hidden lg:flex items-center gap-1.5 text-xs font-medium text-error border border-error/30 hover:bg-error hover:text-white px-3 py-1.5 rounded-md transition-all"
                >
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white border-t border-base-200 shadow-lg">
            <div className="max-w-screen-xl mx-auto px-4 py-3">
              ...
              {/* ✅ Mobile: Avatar + Name */}
              {user && (
                <div className="flex items-center gap-3 py-3 border-b border-base-200 mb-2">
                  <div className="w-9 h-9 rounded-full ring-2 ring-[#1A1A1B] ring-offset-1 bg-neutral text-neutral-content flex items-center justify-center overflow-hidden">
                    {user.image ? (
